...
/*  $(document).ready(function() {
    ...
    if (!touch) {
      ...
      //
      $("body").on("click", ".has-click-popover", function() {
        var el;
        el = $(this);        
        if (el.data("popover") === undefined) {
          el.popover({
      ...
      return selector.each(function(i, elem) {
        return $(elem).validate({
          ...
          highlight: function(e) {
            ...
            return $(e).closest('.controls').removeClass("has-error has-success").addClass('has-error');
          },
          unhighlight:function(e) {
            return $(e).closest('.controls').removeClass("has-error has-success")
          },
          success: function(e) {
            return e.closest(".controls").removeClass("has-error");
          }
        });
      });
    }
